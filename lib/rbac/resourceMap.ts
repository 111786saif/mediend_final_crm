...
export const RESOURCE_MAP = {
  ...
  "main.master_data.hospitals": { label: "Master Data: Hospitals Tab", component: "MasterDataHospitalsTab" },
  "main.master_data.doctors": { label: "Master Data: Doctors Tab", component: "MasterDataDoctorsTab" },
  "main.master_data.tpas": { label: "Master Data: TPAs Tab", component: "MasterDataTpasTab" },
  "main.master_data.insurance": { label: "Master Data: Insurance Tab", component: "MasterDataInsuranceTab" },
  "main.master_data.anesthesia": { label: "Master Data: Anesthesia Tab", component: "MasterDataAnesthesiaTab" },
  "main.master_data.treatments": { label: "Master Data: Treatments Tab", component: "MasterDataTreatmentsTab" },
  "main.master_data.treatment_categories": { label: "Master Data: Treatment Categories Tab", component: "MasterDataTreatmentCategoriesTab" },
