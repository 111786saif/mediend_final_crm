...
const LEAD_STATUS_OVERRIDE_ROLES = new Set<UserRole>(['SUPER_ADMIN', 'ADMIN', 'MD', 'EXECUTIVE_ASSISTANT',])
const LEAD_PROFILE_OVERRIDE_ROLES = new Set<UserRole>(['SUPER_ADMIN', 'ADMIN', 'EXECUTIVE_ASSISTANT',])
