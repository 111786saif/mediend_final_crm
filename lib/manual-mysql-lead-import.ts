...
export const MANUAL_MYSQL_LEAD_FIELDS: ManualMySQLLeadField[] = [
  {
    ...
    section: 'Identity',
    helperText:
      'Lead date only. Use DD/MM/YYYY with optional time, for example 12/08/2026 10:30 AM. Future dates are not allowed, and manual import does not use this to set assignment date.',
    sample: '12/08/2026 10:30 AM',
  },
