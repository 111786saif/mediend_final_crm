...
export const navItems: NavItem[] = [
  ...
  {
    title: 'Inv Transfers & Kits',
    url: '/inventory?tab=Transfers+%26+kits',
    icon: ArrowLeftRight,
  },
  {
    title: 'Inv Sales',
  ...
  {
    title: 'Inv Payments',
    url: '/inventory?tab=Payments',
    icon: Wallet,
  },
  {
    title: 'Inv Implant P&L',
    url: '/inventory?tab=Implant+P%26L',
    icon: IndianRupee,
  },
  {
    title: 'Inv Delivery Expenses',
    url: '/inventory?tab=Delivery+expenses',
    icon: Truck,
  },
  {
    title: 'Inv Vendors',
    url: '/inventory?tab=Vendors',
    icon: Users,
  },
  {
    title: 'Inv Implant Catalog',
    url: '/inventory?tab=Implant+catalog',
    icon: Package,
  },
  {
    title: 'Inv Locations',
    url: '/inventory?tab=Locations',
    icon: MapPin,
  },
  {
    title: 'Inv Activity Log',
    url: '/inventory?tab=Activity+log',
    icon: Activity,
  },
  {
    title: 'Fin Approvals',
