...
export function LeadRemarksDrawer({
  ...
  const canEditRemarks = data?.canEditRemarks ?? false
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-xl p-0 gap-0 flex flex-col">
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  <span>
                    {canEditRemarks
                      ...
                      : 'Your role cannot add remarks for this lead.'}
                  </span>
        ...
        <SheetFooter className="border-t">
          ...
          <Button onClick={handleSave} disabled={saving || isLoading || !data || !canEditRemarks || !canSave}>
            {saving ? (
              <>
