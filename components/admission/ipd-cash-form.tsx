  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        alternateContactName: formData.alternateContactName || null,
        alternateContactNumber: formData.alternateContactNumber || null,
        category: formData.category || null,
        treatmentName: formData.treatment || null,
        ...
        subventionFee: formData.subventionFee ? parseFloat(formData.subventionFee) : null,
        finalEmiAmount: formData.finalEmiAmount ? parseFloat(formData.finalEmiAmount) : null,
        instrument,
        implantConsumables,
