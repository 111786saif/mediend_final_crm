        ...
        <div className="flex-1 flex flex-wrap gap-4 items-center lg:justify-end">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="w-72 bg-[#07112f] border-[#283150] rounded-lg text-xs text-[#dce1ff] placeholder-[#c7c6cd]/30 focus:ring-1 focus:ring-[#22d3ee] focus:border-[#22d3ee] focus:outline-none h-9 px-3"
